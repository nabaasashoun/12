...
import { Heart, MessageSquare, Star, Bookmark, Search, MoreHorizontal } from 'lucide-react';
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <p className="text-[] font-bold text-gray-900">Trending</p>
      ...
      <div className="p-3 sm:p-4 md:p-6 max-w-4xl mx-auto">
        ...
        <div className="flex justify-end items-center mb-4 sm:mb-6 gap-2 sm:gap-3">
          <div className="flex items-center w-full sm:w-auto">
            <div className="flex w-full sm:w-64 border border-gray-300 rounded-lg overflow-hidden">
              <select className="w-1/5 px-3 py-2 bg-white text-black focus:outline-none text-sm border-r border-gray-300">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
          {filteredPosts.map((post) => {
            ...
            return (
              <div key={post.id} className="bg-white rounded-lg shadow-sm overflow-hidden flex flex-col border border-gray-200">
