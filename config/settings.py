...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': str(LOGS_DIR / 'pesapal.log'),
...
PESAPAL_IPN_URL = 'https://subordinative-phyliss-hemispherically.ngrok-free.dev/api/payments/ipn/'
PESAPAL_CALLBACK_URL = 'https://subordinative-phyliss-hemispherically.ngrok-free.dev/api/payments/callback/'
